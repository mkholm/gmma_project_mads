...
# scan_var output
print(" RESULT_LAB   dG_wt_fit dG_wt_true      B_D    B_max  cor_s  cor_all  cor_low  cor_p_stab  cor_p_neu  cor_p_dest cor_p_neustab cor_s_stab  cor_s_neu  cor_s_dest cor_s_neustab  slope    inter  frac_act RSS  scan")
print(sprintf(" RESULT_VAL %7.3f  %7.3f  %7.3f  %5.3f    %5.3f    %5.3f     %5.3f    %5.3f  %5.3f %5.3f    %5.3f  %5.3f   %5.3f   %5.3f  %5.3f    %5.3f     %5.3f  %7.3f %7.3f  %7.3f ",
              cp$dG_wt, dG_wt, cp$B_D, cp$B_max,
              rs_all, rp_all,
              rp, rp_stab, rp_neu, rp_destab,rp_neustab,
              rs_stab, rs_neu, rs_destab, rs_neustab,
...
# # for following ddGs value of specific subst
# print(" RESULT_LAB   dG_wt_fit dG_wt_true     B_D    B_max  cor_s  cor_all  cor_low  cor_p_stab  cor_p_neu  cor_p_dest cor_s_stab  cor_s_neu  cor_s_dest    slope    inter  frac_act  scan ddGs_fit_stab rank_ddGs_fit_stab")
# print(sprintf(" RESULT_VAL %7.3f  %7.3f  %7.3f  %7.3f  %5.3f    %5.3f    %5.3f     %5.3f    %5.3f     %5.3f  %5.3f    %5.3f     %5.3f  %7.3f  %7.3f     %5.3f  %5.3f %5.3f  %5.3f",
#               cp$dG_wt, dG_wt, cp$B_D, cp$B_max,
#               rs_all, rp_all, 
#               rp, rp_stab, rp_neu, rp_destab,
#               rs_stab, rs_neu, rs_destab,
#               fit1$coefficients["synth"], fit1$coefficients["(Intercept)"], frac_act, extra$scan_var,
#               gmma[which(ddG_param$cat == 1),"ddG"], gmma[which(ddG_param$cat == 1),"rank"] 
#               ))
