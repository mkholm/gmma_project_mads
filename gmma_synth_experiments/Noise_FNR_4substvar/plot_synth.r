...
plot(d$scan, d$cor_p_neustab, 
     xlab = "Noise (% False negative rate)", ylab = "r", main = "r, true ddGs [-10;0.5]")
plot(d$scan, d$cor_s_neustab, 
     xlab = "Noise (% False negative rate)", ylab = "ρ", main = "ρ, true ddGs [-10;0.5]")
...
plot(d$scan, d$RSS, type = "l"
     ,xlab = "False negative rate (%)", ylab = "Residual sum of squares", main = "Model fit")
dev.off()
